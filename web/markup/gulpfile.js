...
// Copy separate files into separate
function separate() {
  return src(path.src.separate)
    .pipe(size())
    .pipe(dest(path.build.separate));
}
...
function watchAndServe() {
  ...
  watch(path.watch.separate, separate);
...
exports.default = series(parallel(html, js, style, images, icons, fonts, separate, misc), watchAndServe);
exports.build = series(clean, parallel(html, js, style, images, icons, separate, fonts, misc));
