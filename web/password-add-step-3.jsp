                ...
                <div class="password-form__content">
                    <form class="form password-form__form" action="">
                        ...
                        <textarea class="mdc-text-field__input" rows="2" cols="40" aria-label="Label"></textarea></span><span class="mdc-notched-outline"><span class="mdc-notched-outline__leading"></span><span class="mdc-notched-outline__notch"><span class="mdc-floating-label">Экспертиза ГУП «Центр кибербезопасности»</span></span><span class="mdc-notched-outline__trailing"></span></span></label>
                            ...
                            <div class="form__fieldset">
                                <div class="form__title form__title--legend">Принятие информационной системы</div>
                                <div class="form__grid mdc-layout-grid">
                                    <div class="form__row mdc-layout-grid__inner">
                                        <div class="form__cell mdc-layout-grid__cell mdc-layout-grid__cell--span-8">
                                            <div class="form__group">
                            ...
                            <div class="form__fieldset">
                                <div class="form__title form__title--legend">Ввод в промышленную эксплуатацию</div>
                                <div class="form__grid mdc-layout-grid">
                                    <div class="form__row mdc-layout-grid__inner">
                                        <div class="form__cell mdc-layout-grid__cell mdc-layout-grid__cell--span-8">
                                            <div class="form__group">
                            ...
                            <div class="form__fieldset">
                                <div class="form__title form__title--legend">Совершенствование информационной системы</div>
                                <div class="form__grid mdc-layout-grid">
                                    <div class="form__row mdc-layout-grid__inner">
                                        <div class="form__cell mdc-layout-grid__cell mdc-layout-grid__cell--span-8">
                                            <div class="form__group">
                        ...
                        <div class="form__actions form__actions--passwords-form">
                            <div class="form__actions-row">
                                <div class="form__actions-cell form__actions-cell--back"><a class="btn mdc-button mdc-button--dark" href="password-add-step-2.jsp">
                                ...
                                <div class="form__actions-cell form__actions-cell--next"><a class="btn mdc-button" href="password-add-step-4.jsp">
